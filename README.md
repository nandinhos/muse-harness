...
profiles/clearer-muse/        # cópia canônica: skills, commands, hooks, scripts, manifest
  skills/{clearer,token-economy,code-minimalism,debugging}/
...
adr/001…004                   # decisões: Context7, lições, minimalismo, hook órfão
...
### The `clearer-muse` profile v0.3.0
...
`templates/mcp.json`, `adr/001–004`, `img/CLEARER-MUSE.jpg`, `HANDOFF.md`.
